...
\caption{Comparison of Query Execution Times (measured in milliseconds) at Various SPARQL Endpoints With and Without Local Data (Cache) (average of three trials)}
\label{fig:chart}
\end{figure}
