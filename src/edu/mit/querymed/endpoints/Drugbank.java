...
public class Drugbank {
	...
	public static String[] properties  = {
			...
			"http://www4.wiwiss.fu-berlin.de/drugbank/resource/drugbank/drugIdNumberPage",
	...
	public static void main(String[] args){
	     ...
	     ResultSet results = QueryExecutionFactory.sparqlService(Util.DRUGBANK_ENDPOINT,query).execSelect();
